...
LOCAL_IMAGE_API_URL=https://ngoe5jtsustl.shares.zrok.io/images
...
`LOCAL_IMAGE_API_URL`는 이미지 생성을 담당하는 외부 OpenAI 호환 주소입니다. 현재는 제공해주신 zrok 엔드포인트 `https://ngoe5jtsustl.shares.zrok.io/images`를 기본값으로 사용합니다.
